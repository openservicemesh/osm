							...
							Rules: []*trafficpolicy.Rule{
								{
									...
									AllowedPrincipals: mapset.NewSet(identity.WildcardServiceIdentity),
								},
								{
									Route: trafficpolicy.RouteWeightedClusters{
					...
					Rules: []*trafficpolicy.Rule{
						{
							...
							AllowedPrincipals: mapset.NewSet(tests.BookbuyerServiceIdentity.AsPrincipal("cluster.local")),
						},
						{
							Route: trafficpolicy.RouteWeightedClusters{
								HTTPRouteMatch:   tests.BookstoreSellHTTPRoute,
			...
			inputRules: []*trafficpolicy.Rule{
				{
					...
					AllowedPrincipals: mapset.NewSetWith(identity.K8sServiceAccount{Name: "foo", Namespace: "bar"}.ToServiceIdentity().AsPrincipal("cluster.local")),
				},
			},
			expectFunc: func(assert *tassert.Assertions, actual []*xds_route.Route) {
