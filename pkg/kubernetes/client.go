...
// GetMultiClusterService returns an v1alpha1 MultiClusterService if it exists, or nil
func (c Client) GetMultiClusterService(name, namespace string) (*v1alpha1.MultiClusterService, error) {
...
func (c Client) ListMultiClusterServices() ([]*v1alpha1.MultiClusterService, error) {
