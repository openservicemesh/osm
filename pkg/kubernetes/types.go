...
type Client struct {
	...
	versionInterface versioned.Interface
...
type Controller interface {
	...
	GetMultiClusterSvc(name, namespace string) (*v1alpha1.MultiClusterService, error)

	// ListMultiClusterServices returns a list of v1alpha1 MulticClusterServices if any exist, or nil
	ListMultiClusterServices(name, namespace string) ([]*v1alpha1.MultiClusterService, error)
}
