...
func (m *MockController) GetMultiClusterService(arg0, arg1 string) (*v1alpha1.MultiClusterService, error) {
	m.ctrl.T.Helper()
...
func (m *MockController) ListMultiClusterServices() ([]*v1alpha1.MultiClusterService, error) {
	m.ctrl.T.Helper()
