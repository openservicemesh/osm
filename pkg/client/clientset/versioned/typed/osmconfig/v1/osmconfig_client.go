...
// OsmV1Client is used to interact with features provided by the osm.k8s.io group.
type OsmV1Client struct {
	restClient rest.Interface
}

func (c *OsmV1Client) OSMConfigs(namespace string) OSMConfigInterface {
	return newOSMConfigs(c, namespace)
}
