...
func NewClient(kubeController k8sInterfaces.Controller, configClient config.Controller, cfg configurator.Configurator) *client { //nolint: revive // unexported-return
	return &client{
