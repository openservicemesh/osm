...
func NewProvider(kubeConfig *rest.Config, namespaceController namespace.Controller, cfg configurator.Configurator, stop chan struct{}, providerIdent string) *Client {
