						...
						Rules: []*trafficpolicy.Rule{
							{
								...
								AllowedPrincipals: mapset.NewSet(identity.WildcardServiceIdentity.String()),
							},
						},
					},
				},
						...
						Rules: []*trafficpolicy.Rule{
							{
								...
								AllowedPrincipals: mapset.NewSet(identity.ServiceIdentity("ingressGw.ingressGwNs.cluster.local").String()),
							},
						},
					},
				},
