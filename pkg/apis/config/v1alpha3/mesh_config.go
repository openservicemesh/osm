...
var (
	ProxyModeLocalhost ProxyMode = "LOCALHOST"
	ProxyModePodIP     ProxyMode = "POD_IP"
)
...
type SidecarSpec struct {
	...
	// ProxyMode defines the network interface the envoy proxy will use to send traffic to the backend service application. Acceptable values are [`LOCALHOST`, `POD_IP`]. The default is `LOCALHOST`
