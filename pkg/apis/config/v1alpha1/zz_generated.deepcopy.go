...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EquivalenceSpec) DeepCopyInto(out *EquivalenceSpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EquivalenceSpec.
func (in *EquivalenceSpec) DeepCopy() *EquivalenceSpec {
	if in == nil {
		return nil
	}
	out := new(EquivalenceSpec)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *RemoteService) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RemoteServiceList) DeepCopyInto(out *RemoteServiceList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]RemoteService, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RemoteServiceList.
func (in *RemoteServiceList) DeepCopy() *RemoteServiceList {
	if in == nil {
		return nil
	}
	out := new(RemoteServiceList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *RemoteServiceList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RemoteServiceSpec) DeepCopyInto(out *RemoteServiceSpec) {
	*out = *in
	out.Cluster = in.Cluster
	out.Equivalence = in.Equivalence
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RemoteServiceSpec.
func (in *RemoteServiceSpec) DeepCopy() *RemoteServiceSpec {
	if in == nil {
		return nil
	}
	out := new(RemoteServiceSpec)
	in.DeepCopyInto(out)
	return out
}
