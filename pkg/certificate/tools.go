...
var log = logger.New("certificate")
...
func GetPodFromCertificate(cn CommonName, kubecontroller kubernetes.Controller) (*v1.Pod, error) {
...
func getCertificateCommonNameMeta(cn CommonName) (*certificateCommonNameMeta, error) {
...
func GetServiceAccountFromProxyCertificate(cn CommonName) (service.K8sServiceAccount, error) {
