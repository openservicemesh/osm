...
func NewCertificateManager(ctx context.Context, kubeClient kubernetes.Interface, configClient configClientset.Interface, kubeConfig *rest.Config, cfg configurator.Configurator,
