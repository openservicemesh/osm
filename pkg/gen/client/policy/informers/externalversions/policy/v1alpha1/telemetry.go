	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PolicyV1alpha1().Telemetries(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PolicyV1alpha1().Telemetries(namespace).Watch(context.TODO(), options)
			},
		},
		&policyv1alpha1.Telemetry{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *telemetryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&policyv1alpha1.Telemetry{}, f.defaultInformer)
}
