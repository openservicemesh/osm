...
// List lists all MeshConfigs in the indexer.
func (s *meshConfigLister) List(selector labels.Selector) (ret []*v1alpha3.MeshConfig, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha3.MeshConfig))
	})
	return ret, err
}
...
// List lists all MeshConfigs in the indexer for a given namespace.
func (s meshConfigNamespaceLister) List(selector labels.Selector) (ret []*v1alpha3.MeshConfig, err error) {
...
// Get retrieves the MeshConfig from the indexer for a given namespace and name.
func (s meshConfigNamespaceLister) Get(name string) (*v1alpha3.MeshConfig, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha3.Resource("meshconfig"), name)
	}
	return obj.(*v1alpha3.MeshConfig), nil
}
