...
var multiclusterservicesResource = schema.GroupVersionResource{Group: "config.openservicemesh.io", Version: "v1alpha1", Resource: "multiclusterservices"}

var multiclusterservicesKind = schema.GroupVersionKind{Group: "config.openservicemesh.io", Version: "v1alpha1", Kind: "MultiClusterService"}
