...
type MultiClusterServiceInterface interface {
	Create(ctx context.Context, multiClusterService *v1alpha2.MultiClusterService, opts v1.CreateOptions) (*v1alpha2.MultiClusterService, error)
	Update(ctx context.Context, multiClusterService *v1alpha2.MultiClusterService, opts v1.UpdateOptions) (*v1alpha2.MultiClusterService, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha2.MultiClusterService, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha2.MultiClusterServiceList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.MultiClusterService, err error)
...
func newMultiClusterServices(c *ConfigV1alpha2Client, namespace string) *multiClusterServices {
...
func (c *multiClusterServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.MultiClusterService, err error) {
	result = &v1alpha2.MultiClusterService{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *multiClusterServices) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.MultiClusterServiceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha2.MultiClusterServiceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("multiclusterservices").
...
func (c *multiClusterServices) Create(ctx context.Context, multiClusterService *v1alpha2.MultiClusterService, opts v1.CreateOptions) (result *v1alpha2.MultiClusterService, err error) {
	result = &v1alpha2.MultiClusterService{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("multiclusterservices").
...
func (c *multiClusterServices) Update(ctx context.Context, multiClusterService *v1alpha2.MultiClusterService, opts v1.UpdateOptions) (result *v1alpha2.MultiClusterService, err error) {
	result = &v1alpha2.MultiClusterService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("multiclusterservices").
...
func (c *multiClusterServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.MultiClusterService, err error) {
	result = &v1alpha2.MultiClusterService{}
