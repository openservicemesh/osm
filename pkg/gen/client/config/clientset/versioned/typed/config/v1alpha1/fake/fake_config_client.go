...
import (
	v1alpha1 "github.com/openservicemesh/osm/pkg/gen/client/config/clientset/versioned/typed/config/v1alpha1"
...
func (c *FakeConfigV1alpha1) MultiClusters(namespace string) v1alpha1.MultiClusterInterface {
