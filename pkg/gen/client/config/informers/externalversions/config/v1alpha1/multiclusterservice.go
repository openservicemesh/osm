	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ConfigV1alpha1().MultiClusterServices(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ConfigV1alpha1().MultiClusterServices(namespace).Watch(context.TODO(), options)
			},
		},
		&configv1alpha1.MultiClusterService{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *multiClusterServiceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&configv1alpha1.MultiClusterService{}, f.defaultInformer)
}
