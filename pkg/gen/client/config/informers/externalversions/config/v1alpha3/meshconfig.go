...
type MeshConfigInformer interface {
	...
	Lister() v1alpha3.MeshConfigLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ConfigV1alpha3().MeshConfigs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ConfigV1alpha3().MeshConfigs(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *meshConfigInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&configv1alpha3.MeshConfig{}, f.defaultInformer)
}

func (f *meshConfigInformer) Lister() v1alpha3.MeshConfigLister {
	return v1alpha3.NewMeshConfigLister(f.Informer().GetIndexer())
}
