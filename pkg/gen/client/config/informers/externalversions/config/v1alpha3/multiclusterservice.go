...
import (
	...
	v1alpha3 "github.com/openservicemesh/osm/pkg/gen/client/config/listers/config/v1alpha3"
...
type MultiClusterServiceInformer interface {
	...
	Lister() v1alpha3.MultiClusterServiceLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ConfigV1alpha3().MultiClusterServices(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ConfigV1alpha3().MultiClusterServices(namespace).Watch(context.TODO(), options)
			},
		},
		&configv1alpha3.MultiClusterService{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *multiClusterServiceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&configv1alpha3.MultiClusterService{}, f.defaultInformer)
}

func (f *multiClusterServiceInformer) Lister() v1alpha3.MultiClusterServiceLister {
	return v1alpha3.NewMultiClusterServiceLister(f.Informer().GetIndexer())
}
