...
Running the [test-w-coverage.sh](https://github.com/openservicemesh/osm/blob/release-v0.8/scripts/test-w-coverage.sh) script will create
...
As an example, to create a mock client for the `Configurator` interface defined in the [configurator](https://github.com/openservicemesh/osm/tree/release-v0.8/pkg/configurator) package, add the corresponding mock generation rule in the [rules file](https://github.com/openservicemesh/osm/tree/release-v0.8/mockspec/rules) and generate the mocks using the command `make check-mocks` from the root of the OSM repo.
...
For mesh visibility and debugabbility, one can refer to the endpoints provided under [pkg/debugger](https://github.com/openservicemesh/osm/tree/release-v0.8/pkg/debugger) which contains a number of endpoints able to inspect and list most of the common structures used by the control plane at runtime.
...
[`charts/osm`](https://github.com/openservicemesh/osm/tree/release-v0.8/charts/osm) folder.

The [`charts/osm/values.yaml`](https://github.com/openservicemesh/osm/blob/release-v0.8/charts/osm/values.yaml) file defines the default value for properties
referenced by the different chart templates.

The [`charts/osm/templates/`](https://github.com/openservicemesh/osm/tree/release-v0.8/charts/osm/templates) folder contains the chart templates
...
The [`charts/osm/crds/`](https://github.com/openservicemesh/osm/tree/release-v0.8/charts/osm/crds/) folder contains the charts corresponding to the SMI CRDs.
Experimental CRDs can be found under [`charts/osm/crds/experimental/`](https://github.com/openservicemesh/osm/tree/release-v0.8/charts/osm/crds/experimental).
