...
To get a deeper understanding of how OSM functions - take a look at the detailed [software design](https://github.com/openservicemesh/osm/blob/main/DESIGN.md/).
