...
func newBootstrapCmd(out io.Writer) *cobra.Command {
	...
	f.StringVar(&bootstrap.caPEMFileOut, "caPEMFileOut", "", "full path to the root cert to be created")
	f.StringVar(&bootstrap.caKeyPEMFileOut, "caKeyPEMFileOut", "", "full path to the root cert key to be created")
