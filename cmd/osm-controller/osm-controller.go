...
func startMetricsStore() {
	metricsstore.DefaultMetricsStore.Start(
		...
		metricsstore.DefaultMetricsStore.K8sMeshServiceAccountCount,
		metricsstore.DefaultMetricsStore.K8sMeshIngressCount,
		metricsstore.DefaultMetricsStore.K8sMeshEndpointCount,
