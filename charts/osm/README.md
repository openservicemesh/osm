...
| osm.enableFluentbit | bool | `true` | Enable Fluent Bit sidecar deployment on OSM controller's pod |
...
| osm.multicluster | object | `{"affinity":{},"gatewayLogLevel":"error","nodeSelector":{"kubernetes.io/arch":"amd64","kubernetes.io/os":"linux"},"tolerations":[]}` | OSM multicluster feature configuration |
| osm.multicluster.gatewayLogLevel | string | `"error"` | Log level for the multicluster gateway |
| osm.multicluster.tolerations | list | `[]` | Node tolerations applied to control plane pods. The specified tolerations allow pods to schedule onto nodes with matching taints. |
...
| osm.prometheus.affinity | object | `{}` |  |
| osm.prometheus.image | string | `"prom/prometheus:v2.34.0"` | Image used for Prometheus |
| osm.prometheus.nodeSelector."kubernetes.io/arch" | string | `"amd64"` |  |
| osm.prometheus.nodeSelector."kubernetes.io/os" | string | `"linux"` |  |
...
| osm.tracing.nodeSelector."kubernetes.io/arch" | string | `"amd64"` |  |
